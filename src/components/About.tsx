  ...
  return (
    <section id="about" className="section" ref={ref}>
      <div className="container">
        ...
        <h2 className={'section-title reveal reveal-delay-1' + vis}>Who I am</h2>
        <div className="about-grid">
          <div className={'about-text reveal reveal-delay-2' + vis}>
            <p>
              I am <strong>BluHExH</strong> — also known as Hacker Hex. An open source developer
              and security enthusiast based in Bangladesh.
            </p>
            <p>
              I build tools that help people understand systems better — penetration testing
              utilities, local AI scanners, and practical scripts that run on Termux and beyond.
            </p>
            <p>Stay curious. Break systems carefully. Rebuild them stronger.</p>
            <div className="about-actions">
              <a href="https://github.com/BluHExH" target="_blank" rel="noopener noreferrer" className="btn btn-primary">
                GitHub profile
              </a>
          ...
          <div className={'about-cards stagger' + vis}>
            ...
            <div className="card info-card">
              ...
              <span className="info-value">Python-first, practical tooling</span>
            </div>
            <div className="card info-card">
