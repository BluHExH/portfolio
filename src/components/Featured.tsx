...
const terminal = `$ localvulnai scan ./app
...
Scan complete · 2 findings · offline`
  ...
  return (
    <section id="featured" className="section" ref={ref}>
      <div className="container">
        <p className={'section-label reveal' + vis}>Case study</p>
        <h2 className={'section-title reveal reveal-delay-1' + vis}>Featured work</h2>
        <div className={'feat-card reveal reveal-delay-2' + vis}>
