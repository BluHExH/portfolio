...
.hf-nav.on { background: rgba(11,11,12,0.92); border-bottom-color: #262628; }
.hf-nav-in { height: 64px; display: flex; align-items: center; justify-content: space-between; }
.hf-logo { display: flex; align-items: center; gap: 8px; font-weight: 700; font-size: 16px; z-index: 2; color: #F4F4F2; }
.hf-logo-mark {
  width: 28px; height: 28px; display: grid; place-items: center;
  background: #FF5A1F; color: #fff; border-radius: 8px; font-size: 13px;
}
...
.hf-nav-cta { background: #FF5A1F; color: #fff; font-size: 14px; font-weight: 600; padding: 8px 16px; border-radius: 8px; }
.hf-nav-cta:hover { background: #FF6D38; }
.hf-burg { display: none; flex-direction: column; gap: 5px; width: 28px; padding: 4px; }
.hf-burg span { display: block; height: 2px; background: #F4F4F2; border-radius: 1px; transition: .2s; }
...
@media (max-width: 900px) {
  ...
  .hf-links {
    ...
    background: #0B0B0C; flex-direction: column; align-items: center;
    justify-content: flex-start; padding-top: 40px; gap: 22px;
