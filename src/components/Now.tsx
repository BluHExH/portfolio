  ...
  return (
    <section id="now" className="section" ref={ref}>
      <div className="container now-inner">
        <p className={'section-label reveal' + vis}>Now</p>
        <h2 className={'section-title reveal reveal-delay-1' + vis}>What I am focused on</h2>
        <p className={'section-desc reveal reveal-delay-2' + vis}>
          A live snapshot of current work - updated as priorities shift.
        </p>
        <div className={'now-grid stagger' + vis}>
          {items.map((it) => (
