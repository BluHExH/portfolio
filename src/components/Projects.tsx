    ...
    <div className="slide-card">
      ...
      <div className="slide-foot">
        ...
        <span className="slide-links">
          {p.demo && (
            <a href={p.demo} target="_blank" rel="noopener noreferrer" className="slide-demo">Live</a>
          )}
          <a href={p.url} target="_blank" rel="noopener noreferrer" className="slide-open">Code →</a>
        </span>
      </div>
    </div>
  )
