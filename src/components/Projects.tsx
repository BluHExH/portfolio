...
const projects = [
  ...
  { name: 'knitout-3d-visualizer', description: 'Interactive 3D knitout visualizer with live code editing.', language: 'TypeScript', stars: 0, url: 'https://github.com/BluHExH/knitout-3d-visualizer', tag: '3D / Web' },
  ...
  { name: 'portfolio', description: 'Personal developer portfolio — dark theme, animated sections.', language: 'TypeScript', stars: 0, url: 'https://github.com/BluHExH/portfolio', tag: 'Web' },
  { name: 'GitHub-Profile-Builder', description: 'HEX Forge — AI-powered GitHub profile & README builder platform.', language: 'TypeScript', stars: 0, url: 'https://github.com/BluHExH/GitHub-Profile-Builder-Platform-', tag: 'AI / Platform' },
]

function ProjectCard({ p }: { p: (typeof projects)[0] }) {
  return (
    <a href={p.url} target="_blank" rel="noopener noreferrer" className="slide-card">
      ...
      <div className="slide-foot">
        ...
        <span className="slide-open">Open →</span>
      </div>
    </a>
  )
}
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="section projects-section" ref={ref}>
      ...
      <div className={`slider-wrap reveal reveal-delay-2 ${inView ? 'visible' : ''}`}>
      ...
      <div className="container">
        <div className={`projects-cta reveal reveal-delay-3 ${inView ? 'visible' : ''}`}>
          <a href="https://github.com/BluHExH?tab=repositories" target="_blank" rel="noopener noreferrer" className="btn btn-secondary">
      ...
      <style>{`
        ...
        .slide-card:hover .slide-open { opacity: 1; }
